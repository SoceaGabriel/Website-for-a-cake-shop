...
<meta name="description" content="Pagina de autentificare">
...
<form action="logica_login.php" method="POST" class="formular_inscriere">
<fieldset>
<legend>Autentificare pe site</legend>

<p>Nickname: <input type="text" name="utilizator" /></p>
