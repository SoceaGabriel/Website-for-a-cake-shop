...
<h1>&#10036; Tort aniversar alb cu trandafiri</h1>
<hr/>
<div id="poza"><img src="imagini/tort_aniversare_1.jpg" alt="Poza tort aniversar 1" /></div>
...
<p>Comenzile se primesc pana la ora 20.00.</p>
<p>Pentru torturile standard comenzile se lanseaza cu cel putin 4 ore inainte de ora livrarii.</p>
<p>Pentru torturile personalizate comenzile se lanseaza cu 24 de ore in avans.</p>
...
<div id="pret_produs">75 lei/kg</div>
...
<center>
	...
	{	
		...
		echo "<input type='hidden' id='produs' name='produs' value='Tort aniversar alb cu trandafiri'/>";
