...
<title>Plasați o comandă</title>
<meta name="description" content="Pagina de trimis o comanda">
...
<script type="text/javascript" src="../js/script_t_n.js"></script>
...
<form action="comanda_produs.php" method="post" class="formular_contact" > 
<fieldset>
<legend>Trimite o comandă</legend>
<p>Numele dvs: <input type="text" name="name" /></p>
<p>Email: <input type="email" name="email" /></p>
<p>Telefon*: <input type="tel" name="telefon"/></p>
<p>Adresa*: <input type="text" name="adresa"/></p>
<p>Doriți să cumpărați:</p>
...
<p>Mesaj: <textarea name="message" rows="10" cols="60" ></textarea></p>
<p><input type="submit" value="Trimite comanda" /></p>
...
// Check for empty fields
   ...
   {
		echo "Nu ati introdus nume sau email sau mesaj!";
		return false;
   }
...
$to = 'socea.gabi@gmail.com'; //unde se trimite emailul
